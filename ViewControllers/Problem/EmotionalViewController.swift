...
class EmotionalViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    let tableView = UITableView()
    var cellData = [CellFunctions(tableviewData: "მიჭირს დიდი ხნით ერთ საკითხზე/საქმეზე კონცენტრაცია"),
                    CellFunctions(tableviewData: "მალე ვიღლები"),
                     CellFunctions(tableviewData: "სწრაფად გამოვდივარ წყობიდან/ წონასწორობიდან"),
                    CellFunctions(tableviewData: "შეჯიბრის პროცესი ზედმიწევნით არც მახსოვს, თითქოს „ერთი წამია"),
                    CellFunctions(tableviewData: "ძალების თანაბრად გადანაწილებას ვერ ვახერხებ (ან ძალიან ენერგიული ვარ ან ძალიან მოდუნებული/ შენელებული)"),
                    CellFunctions(tableviewData: "შეჯიბრის ბოლომდე ძალები აღარ მყოფნის"),
                    CellFunctions(tableviewData: "დიდი მნიშვნელობას ვანიჭებ პასუხის დაბრუნებას (სამაგიერო უნდა გადავუხადო)")
    ...
    private let kitxvariLabel: UILabel = {
       let kitxvariLabel = UILabel()
        ...
        kitxvariLabel.text = "ემოციური წონასწორობის და კონცენტრაციის გაძლიერება"
